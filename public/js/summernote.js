...
(function (factory) {
  ...
  var isSupportAmd = "function" === 'function' && __webpack_require__("./node_modules/webpack/buildin/amd-options.js");
  ...
  if (!hasCodeMirror && isSupportAmd && "function" !== 'undefined') {
    if (true) {
      try {
        ...
        /*require.resolve*/("./node_modules/codemirror/lib/codemirror.js");
        hasCodeMirror = true;
      } catch (e) {
        // Do nothing.
      }
  ...
  */
  ...
  if (agent.hasCodeMirror) {
    if (agent.isSupportAmd) {
      new Promise(function(resolve) { resolve(); }).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("./node_modules/codemirror/lib/codemirror.js")]; (function (cm) {
        CodeMirror = cm;
...
module.exports = __webpack_require__("./bower_components/summernote/dist/summernote.js");
